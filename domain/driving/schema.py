...
DRIVING_SCHEMA = {
    ...
    "intents": {
        "control_hardware": {
            "group": "vehicle",
            "description": "창문, 트렁크, 라이트 등 차량의 하드웨어 장치를 직접 제어할 때 사용합니다.",
            "required_slots": ["target_part", "action"],
            "optional_slots": ["location_detail"]
        },
        "control_hvac": {
            "group": "climate",
            "description": "에어컨, 히터, 통풍 시트 등 차량의 공조 및 온도 조절 장치를 제어할 때 사용합니다.",
            "required_slots": ["action"],
            "optional_slots": ["target_temp", "seat_location", "fan_speed", "hvac_mode"]
        },
        "navigate_to": {
            "group": "navigation",
            "description": "특정 주소나 명칭을 가진 목적지로 내비게이션 경로 안내를 요청할 때 사용합니다.",
            "required_slots": ["destination"],
            "optional_slots": ["waypoint"]
        },
        "find_poi": {
            "group": "navigation",
            "description": "주변의 식당, 주유소, 화장실 등 특정 카테고리의 장소를 검색하거나 찾을 때 사용합니다. (단순히 대화 중 장소 이름이 언급된 경우는 제외)",
            "required_slots": ["poi_type"],
            "optional_slots": ["sort_by"]
        },
        "general_chat": {
            "group": "assistant",
            "description": "차량 제어나 길 안내와 관련 없는 모든 일상 대화, 게임, 퀴즈, 농담, 일반적인 지식 질문 등을 처리합니다.",
            "required_slots": [],
            "optional_slots": ["query"]
        },
        "fallback": {
            "group": "system",
            "description": "사용자의 요청을 이해할 수 없거나 지원하지 않는 기능일 때 사용합니다.",
            "required_slots": [],
            "optional_slots": []
        },
    },
